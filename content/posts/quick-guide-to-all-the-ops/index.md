...
I will use the same definition that I gave in my [“Journey to DevOps Whitepaper”](https://blog.scottlogic.com/2019/03/25/the-journey-to-devops.html):
...
If you want to learn more about DevOps principles, I really recommend you checking my whitepaper, or reading the “[Journey to DevOps](https://blog.scottlogic.com/2018/03/13/organizations-journey-to-devops-culture.html)” blog post I wrote on the Scott Logic website.
...
This means infrastructure as code, but using Git to store that code. I think it is a great idea, I may not like the name very much (riding on the “Ops” hype), but there is some merit to it. Weave works have a [great explanation for the practice here](https://www.weave.works/technologies/gitops/).
