...
- **Understand the big O notation** – it is really not that difficult. Here is a [simple article by Rob Bell](https://rob-bell.net/2009/06/a-beginners-guide-to-big-o-notation/) that explains the basics. The fastest general sort is O(n log(n)).
...
To finish on a light note – [“The Fizz Buzz from Outer Space” by DailyWTF](https://thedailywtf.com/articles/The-Fizz-Buzz-from-Outer-Space) is still the funniest story about a paper-based interview that I ever heard!
