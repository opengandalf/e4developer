...
I've written over 150 posts here. Some of the most popular ones - like [HATEOAS - a simple explanation](/posts/hateoas-simple-explanation/), [Spring Boot Best Practices](/posts/spring-boot-best-practices/), and [Please, stop writing so many for loops in Java!](/posts/please-stop-writing-so-many-for-loops-in-java/) - continue to help developers years after they were published.

### Other things I build

- [**The Dice Drop**](https://thedicedrop.com) - Board game media platform covering board games, crowdfunding campaigns, and the tabletop hobby
- [**BattleCast**](https://battlecast.gg) - D&D 5e combat simulator with grid-based battles and Monte Carlo probability analysis
- [**LiveRail London**](https://apps.apple.com/app/liverail-london/id6504809498) - iOS app for fast London journey planning with real-time train status
- [**Chess Spark Miner**](https://github.com/bjedrzejewski/chess-spark-miner) - Open-source tool for analysing Lichess datasets with Apache Spark

### Connect

- Twitter: [@e4developer](https://twitter.com/e4developer)
- GitHub: [bjedrzejewski](https://github.com/bjedrzejewski)
- LinkedIn: [bartoszjedrzejewski](https://www.linkedin.com/in/bartoszjedrzejewski/)
- Personal site: [jedrzejewski.ai](https://jedrzejewski.ai)
